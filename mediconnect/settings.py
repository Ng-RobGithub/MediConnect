...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-!$x*qc48@o39^h1&q17rl-zg*86-@82+0_n-s!wa)#nl7im@!z')
...
# Set STATIC_ROOT to specify the directory where static files will be collected
